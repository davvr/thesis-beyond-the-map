...
#
# EXPLORATORY SCRIPT 2 — NOT PART OF THE PIPELINE
...
# ---------------------------------------------------------------------------
# 2. Project vote shares per province from the last six CIS barometers
# ---------------------------------------------------------------------------
# ---------------------------------------------------------------------------
# 2. Aggregate the 6 most recent CIS barometers
# ---------------------------------------------------------------------------
cis_dir <- "data-raw/cis"
zip_files <- fs::dir_ls(cis_dir, glob = "*.zip")

message("Found ", length(zip_files), " ZIP files")

# Read and stack all barometers
...
# Stack (direct sum of weights across the 6 months)
...
# Save
out_path <- "outputs/first-outputs/exploratory_map_2.png"
